...
urlpatterns = [
    ...
    # E-mail
    url(r'^email/$', views.email_list, name='rest_email'),
    url(r'^email/(?P<pk>\d+)/$', views.email_detail,
        name='rest_email_detail'),
    url(r'^email/(?P<pk>\d+)/send/$', views.email_detail_send,
        name='rest_email_detail_send'),
